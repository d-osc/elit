...
var init_client_request = __esm({
  "src/server/http/client-request.ts"() {
    "use strict";
    init_utils();
    ClientRequest = class extends EventEmitter3 {
...
var init_incoming_message = __esm({
  "src/server/http/incoming-message.ts"() {
    "use strict";
    init_utils();
    IncomingMessage = class extends EventEmitter4 {
...
var init_response = __esm({
  "src/server/http/response.ts"() {
    ...
    init_runtime();
    init_utils();
    ServerResponse = class extends EventEmitter5 {
...
var init_server_runtime = __esm({
  "src/server/http/server-runtime.ts"() {
    ...
    init_response();
    init_utils();
    Server = class extends EventEmitter6 {
...
var Server2 = class extends EventEmitter7 {
