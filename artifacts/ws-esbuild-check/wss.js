...
var init_incoming_message = __esm({
  "src/server/http/incoming-message.ts"() {
    "use strict";
    init_utils();
    IncomingMessage = class extends EventEmitter2 {
...
var init_response = __esm({
  "src/server/http/response.ts"() {
    ...
    init_runtime();
    init_utils();
    ServerResponse = class extends EventEmitter3 {
...
var init_server_runtime = __esm({
  "src/server/http/server-runtime.ts"() {
    ...
    init_response();
    init_utils();
    Server = class extends EventEmitter4 {
...
var Server2 = class extends EventEmitter5 {
...
var WebSocket = class extends EventEmitter6 {
...
var WSSServer = class extends EventEmitter8 {
  constructor(options, callback) {
    super();
    this.clients = /* @__PURE__ */ new Set();
    this.options = options || {};
