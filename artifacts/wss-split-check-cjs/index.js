...
var import_node_events, ClientRequest;
...
var import_node_events2, IncomingMessage;
var init_incoming_message = __esm({
  "src/server/http/incoming-message.ts"() {
    "use strict";
    import_node_events2 = require("node:events");
    init_utils();
    IncomingMessage = class extends import_node_events2.EventEmitter {
...
var import_node_events3, ServerResponse;
var init_response = __esm({
  "src/server/http/response.ts"() {
    ...
    init_runtime();
    init_utils();
    ServerResponse = class extends import_node_events3.EventEmitter {
...
var import_node_events4, Server;
var init_server_runtime = __esm({
  "src/server/http/server-runtime.ts"() {
    ...
    init_response();
    init_utils();
    Server = class extends import_node_events4.EventEmitter {
...
__export(index_exports, {
  ...
  WSSClient: () => WSSClient,
  WSSServer: () => WSSServer,
  createWSSClient: () => createWSSClient,
  createWSSServer: () => createWSSServer,
...
init_runtime();
init_utils();
var Server2 = class extends import_node_events5.EventEmitter {
