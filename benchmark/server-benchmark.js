/**
 * Benchmark: Elysia vs elit/server
 * Tests HTTP server performance across different runtimes
 */
 ...
 * Start elit server
 */
async function startElitServer() {
  try {
    ...
    console.log(`✓ elit server started on port ${PORT_ELIT}`);
    return server;
  } catch (error) {
    console.error(`✗ Failed to start elit server: ${error.message}`);
    throw error;
  }
}
...
async function runBenchmark() {
  console.log('╔════════════════════════════════════════════════════════╗');
  console.log('║        Benchmark: Elysia vs elit/server               ║');
  console.log('╚════════════════════════════════════════════════════════╝\n');
  ...
  const elitServer = await startElitServer();
  console.log('');
  ...
  // Benchmark elit
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('Benchmarking elit/server...');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
function printResults() {
  ...
  // Table header
  console.log('┌─────────────────┬──────────────┬──────────────┐');
  console.log('│ Metric          │ Elysia       │ elit/server  │');
  console.log('├─────────────────┼──────────────┼──────────────┤');
  ...
  if (results.elysia.rps > 0) {
    ...
    // Comparison
    const faster = results.elysia.rps > results.elit.rps ? 'Elysia' : 'elit/server';
