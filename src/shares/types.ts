...
import type { ElitSMTPServerConfig, ElitSMTPServerHandle } from '../server/smtp-server';

// Forward declarations to avoid circular dependency
export type Router = import('../server/server').ServerRouter;
export type StateManager = import('../server/server').StateManager;
export type WebSocketConnection = import('../server/ws').WebSocket;
export type WebSocketRequest = import('../server/http').IncomingMessage;
