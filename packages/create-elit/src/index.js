...
async function generateTemplate(projectPath, projectName, template) {
    // Create package.json
    const packageJson = {
        name: projectName,
        version: '0.0.0',
...
async function generateFullTemplate(projectPath, projectName) {
...
async function generateMinimalTemplate(projectPath, projectName) {
