...
- Use `elit/server` for HMR, API routes, and shared state
...
- [ ] Update server imports to `elit/server` where needed
...
- 💬 [GitHub Discussions](https://github.com/d-osc/elit/discussions)
